...
class Repayment(models.Model):
    ...
    head_of_gob_contact = fields.Char(string='Head of Management Contact', help="This phone number is used to send messages to SplitPay management", required=True)
